...
import { AboutCard } from "../ComponentCard/AboutCard"; // Make sure path is correct
...
export const About = () => {
  ...
  return (
    <>
      ...
      {showCard && (
        <div 
          className="fixed inset-0 z-60 flex items-center justify-center bg-black/20 backdrop-blur-sm p-2 md:p-15  "
