...
export const Contact = () => {
  ...
  return (
    <div 
    id="contact" 
    className="relative h-full overflow-hidden rounded-3xl bg-white/90 dark:bg-black border border-border p-3 m-2 md:m-0 hover:border-purple-500/50 transition-colors">
